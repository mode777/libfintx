...
namespace libfintx
{
    public class Main
    {
        ...
        /// Transactions
        /// </returns>
        public static async Task<HBCIDialogResult<List<TStatement>>> Transactions_camt(ConnectionContext context, TANDialog tanDialog, bool anonymous, camtVersion camtVers,
